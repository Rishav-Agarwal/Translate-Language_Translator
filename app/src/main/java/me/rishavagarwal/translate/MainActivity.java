...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseDatabase = FirebaseUtils.getDb();

        if (FirebaseAuth.getInstance().getCurrentUser() != null) {
            databaseReference = FirebaseUtils.getRef();
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            if (resultCode == RESULT_CANCELED) {
                Translate.showToast(getString(R.string.sign_in_cancelled), this);
            } else if (resultCode == RESULT_OK) {
                Translate.showToast(getString(R.string.signed_in), this);
            }
        }
    }
    ...
    //When back button is pressed, exit
    @Override
                ...
                if (FirebaseAuth.getInstance().getCurrentUser() == null) {
                    ...
                    builder.setPositiveButton(getString(R.string.yes), new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            Translate.showToast("Signed Out", MainActivity.this);
                        }
                    });
